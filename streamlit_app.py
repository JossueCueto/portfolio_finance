...
with st.sidebar:
    ...
    st.markdown('Bachiller en Ciencias Administrativas, segundo puesto de mi promoción. Dominio del idioma inglés a nivel intermedio. Habilidades comunicativas y de trabajo en equipo, capacidad analítica y búsqueda constante de aprendizaje. Conocimiento e interés en mercado de capitales y gestión de portafolios.')
