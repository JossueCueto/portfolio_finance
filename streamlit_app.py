...
with st.sidebar:
    ...
    st.markdown('Egresado de la carrera de Ciencias Administrativas, segundo puesto en mi promoción. Dominio del idioma inglés a nivel intermedio. Conocimiento en mercado de capitales y gestión de portafolios. Habilidades comunicativas y de trabajo en equipo, capacidad analítica y búsqueda constante de aprendizaje. Interés en el área de inversiones.')
